...
void ListAtomicCell::drawRect(KDContext * ctx, KDRect rect) const {
  ...
  ctx->fillRect(m_atomRect(), Palette::AtomColor[m_atom.type]);
  ...
  ctx->drawString(m_atom.symbol, symbolPoint, KDFont::LargeFont, Palette::AtomText, Palette::AtomColor[m_atom.type]);
  ...
  ctx->drawString(protons, protonsPoint, KDFont::SmallFont, Palette::AtomText, Palette::AtomColor[m_atom.type]);
  ...
  mass[8] = 0;
  ctx->drawString(mass, massPoint, KDFont::SmallFont, Palette::AtomText, Palette::AtomColor[m_atom.type]);
